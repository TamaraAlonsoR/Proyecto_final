       ...
       include ('nav2.php');
           ...
           while ($fila = mysqli_fetch_row($resultado))
            {
               ...
               echo '<td id="td"><input type="submit" value="Eliminar persona"></td>';
            echo '</form>';
			}}echo '</table>';
		}
                ...
                <form action="insertar_user.php" method="post">
                    <div class="row formulario">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="nac" name="nac" placeholder="Fecha nacimiento YYMMDD">
        ...
        <div class="row" id="añadido">
            ...
            <div class="col-8 formulario" id="oculto">
                ...
                ?>
                        <input type=button class="btn btn-primary btn-lg btn-block" id="datosOcupacion" value="Añadir datos de ocupación">
                    </div>
		...
		//en una inserción/borrado/modificación no hay que recorrer filas para visualizar
